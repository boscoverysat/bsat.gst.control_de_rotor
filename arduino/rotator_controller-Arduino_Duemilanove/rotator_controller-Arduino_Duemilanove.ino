...
#define DIR_AZ 11 //PIN for Azimuth Direction
#define STEP_AZ 10 //PIN for Azimuth Steps
//#define DIR_EL 6 //PIN for Elevation Direction
//#define STEP_EL 7 //PIN for Elevation Steps
#define DIR_EL 8 //PIN for Elevation Direction
...
#define MS1 7 //PIN for step size
#define EN 6 //PIN for Enable or Disable Stepper Motors
...
#define HOME_AZ 12 //Homing switch for Azimuth
#define HOME_EL 13 //Homing switch for Elevation
